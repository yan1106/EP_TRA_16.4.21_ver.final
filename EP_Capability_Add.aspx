...
<body>
    ...
    <legend class="legend" style="font-weight: 700; font-size: large;">Capability Information</legend> 
      <table> 
        ...
        <asp:GridView ID="GD_CAP" runat="server" AutoGenerateColumns="False" ForeColor="#333333" CellPadding="4" GridLines="None" OnRowCommand="GD_CAP_RowCommand" OnSelectedIndexChanged="GD_CAP_SelectedIndexChanged" OnRowDeleting="GD_CAP_RowDeleting1"
            >
         ...
         <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
            ...
            <ItemTemplate>
                <asp:ImageButton ID="ImageButton_View" runat="server"  ImageUrl="../icon/view.jpg"  CommandName="View" />
                <asp:ImageButton ID="ImageButton2_Update" runat="server" ImageUrl="../icon/update.jpg"  CommandName="Update" />
                <asp:ImageButton ID="ImageButton3_Delete" runat="server" ImageUrl="../icon/delete.jpg"  CommandName="Delete" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
            </ItemTemplate>
           </asp:TemplateField>
                <asp:BoundField DataField="CAP_EP_Name" HeaderText="Packge_Name" />
                <asp:BoundField DataField="npiuser" HeaderText="User_Name" />
                <asp:BoundField DataField="Update_Time" HeaderText="Update_Time" />
            </Columns>

             <PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" />
            <SelectedRowStyle BackColor="#D1DDF1" Font-Bold="True" ForeColor="#333333" />
            <HeaderStyle BackColor="#006699" Font-Bold="True" ForeColor="White" CssClass="style-GD" />
       ...
       <br />
         <div>
            <table>
                <tr>
                    <td>Packge_Name: </td>
                    <td><asp:TextBox ID="Text_Packge_insert" runat="server" Height="20px"></asp:TextBox></td>
                </tr>
            </table>
        </div>  
        <br />   
 ...
 collapse;width:900pt" >
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td width="160">
                         <asp:TextBox ID="Text__CAP_1" runat="server"></asp:TextBox>
                     </td>
                 ...
                 <tr class="style-td-gray">
                     ...
                     <td>
                         <asp:TextBox ID="Text__CAP_2" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-white">
                     ...
                     <td>
                         <asp:TextBox ID="Text__CAP_3" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-gray" height="12">
                     ...
                     <td>
                         <asp:TextBox ID="Text__CAP_4" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-white" height="38">
                     ...
                     <td>
                         <asp:TextBox ID="Text__CAP_5" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>
                         <asp:TextBox ID="Text__CAP_6" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-white">
                     ...
                     <td width="160">
                         <asp:TextBox ID="Text__CAP_7" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>
                         <asp:TextBox ID="Text__CAP_8" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-white" height="22">
                     ...
                     <td width="160">
                         <asp:TextBox ID="Text__CAP_9" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-gray" height="38">
                     ...
                     <td width="160">
                         <asp:TextBox ID="Text__CAP_10" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-white" height="22">
                     ...
                     <td class="auto-style243" width="160">
                         <asp:TextBox ID="Text__CAP_11" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>
                         <asp:TextBox ID="Text__CAP_12" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-white" height="22">
                     ...
                     <td width="160">
                         <asp:TextBox ID="Text__CAP_13" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-gray" height="95">
                     ...
                     <td width="160">
                         <asp:TextBox ID="Text__CAP_14" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-white" height="22">
                     ...
                     <td width="160">
                         <asp:TextBox ID="Text__CAP_15" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-gray">
                     ...
                     <td>
                         <asp:TextBox ID="Text__CAP_16" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-white">
                     ...
                     <td width="160">
                         <asp:TextBox ID="Text__CAP_17" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-gray" height="57">
                     ...
                     <td width="160">
                         <asp:TextBox ID="Text__CAP_18" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-white">
                     ...
                     <td width="160" class="auto-style312">
                         <asp:TextBox ID="Text__CAP_19" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>
                         <asp:TextBox ID="Text__CAP_20" runat="server"></asp:TextBox>
                     </td>
                 ...
                 <tr class="style-td-white" height="22">
                     ...
                     <td width="160">
                         <asp:TextBox ID="Text__CAP_21" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>
                         <asp:TextBox ID="Text__CAP_22" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-white" height="38">
                     ...
                     <td width="160">
                         <asp:TextBox ID="Text__CAP_23" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>
                         <asp:TextBox ID="Text__CAP_24" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-white" height="22">
                     ...
                     <td width="160">
                         <asp:TextBox ID="Text__CAP_25" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>
                         <asp:TextBox ID="Text__CAP_26" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-white">
                     ...
                     <td width="160" class="auto-style312">
                         <asp:TextBox ID="Text__CAP_27" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>
                         <asp:TextBox ID="Text__CAP_28" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-white">
                     ...
                     <td width="160">
                         <asp:TextBox ID="Text__CAP_29" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>
                         <asp:TextBox ID="Text__CAP_30" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-white" height="22">
                     ...
                     <td width="160">
                         <asp:TextBox ID="Text__CAP_31" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>
                         <asp:TextBox ID="Text__CAP_32" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-white" height="22">
                     ...
                     <td width="160">
                         <asp:TextBox ID="Text__CAP_33" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-gray" height="22">
                     ...
                     <td>
                         <asp:TextBox ID="Text__CAP_34" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-white" height="22">
                     ...
                     <td width="160">
                         <asp:TextBox ID="Text__CAP_35" runat="server"></asp:TextBox>
                     </td>
                 ...
                 <tr class="style-td-gray" height="22">
                     ...
                     <td  colspan="2">
                         <asp:TextBox ID="Text__CAP_36" runat="server"></asp:TextBox>
                     </td>
                 </tr>
                 <tr class="style-td-white" height="22">
                     ...
                     <td  colspan="2" width="274" style="text-align:center;">
                         ...
                         <asp:TextBox ID="Text__CAP_37" runat="server"></asp:TextBox>
                     </td>
                 </tr>
                 <tr class="style-td-gray" height="22">
                     ...
                     <td  colspan="2">
                         <asp:TextBox ID="Text__CAP_38" runat="server"></asp:TextBox>
                     </td>
                 </tr>
                 <tr class="style-td-white" height="22">
                     ...
                     <td  colspan="2" width="274">
                         ...
                         <asp:TextBox ID="Text__CAP_39" runat="server"></asp:TextBox>
                     </td>
                 </tr>
                 <tr class="style-td-gray" height="34">
                     ...
                     <td  colspan="2">
                         <asp:TextBox ID="Text__CAP_40" runat="server"></asp:TextBox>
                     </td>
                 </tr>
                 <tr class="style-td-white" height="22">
                     ...
                     <td  colspan="2">
                         <asp:TextBox ID="Text__CAP_41" runat="server"></asp:TextBox>
                     </td>
                 </tr>
                 <tr class="style-td-gray" height="34">
                     ...
                     <td colspan="2">
                         <asp:TextBox ID="Text__CAP_42" runat="server"></asp:TextBox>
                     </td>
                 </tr>
                 <tr class="style-td-white" height="22">
                     ...
                     <td class="style-td-red" colspan="2">
                         <asp:TextBox ID="Text__CAP_43" runat="server"></asp:TextBox>
                     </td>
                 </tr>
                 <tr class="style-td-gray">
                     ...
                     <td class="auto-style316">
                         <asp:TextBox ID="Text__CAP_44" runat="server"></asp:TextBox>
                     </td>
                     <td class="auto-style316">
                         <asp:TextBox ID="Text_CAP_POR_EP_01" runat="server"></asp:TextBox>
                     </td>
                 </tr>
                 <tr class="style-td-white" height="22">
                     <td class="style-keyitem-details">Expose pad</td>
                     <td>
                         <asp:TextBox ID="Text__CAP_45" runat="server"></asp:TextBox>
                     </td>
                     <td >
                         <asp:TextBox ID="Text_CAP_POR_EP_2" runat="server"></asp:TextBox>
                     </td>
                 </tr>
                 <tr class="style-td-gray" height="42">
                     <td class="style-keyitem-details" height="42" width="192">PSV1(PI1/PBO1) opening</td>
                     <td>
                         <asp:TextBox ID="Text__CAP_46" runat="server"></asp:TextBox>
                     </td>
                     <td >
                         <asp:TextBox ID="Text_CAP_POR_EP_3" runat="server"></asp:TextBox>
                     </td>
                 </tr>
                 <tr class="style-td-white" height="22">
                     <td class="style-keyitem-details" height="22" width="192">Bump diameter</td>
                     <td>
                         <asp:TextBox ID="Text__CAP_47" runat="server"></asp:TextBox>
                     </td>
                     <td >
                         <asp:TextBox ID="Text_CAP_POR_EP_4" runat="server"></asp:TextBox>
                     </td>
                 </tr>
                 <tr class="style-td-gray" height="42">
                     <td class="style-keyitem-details" height="42" width="192">Low SPEC of min RDL
                         ...
                         Width</td>
                     <td>
                         <asp:TextBox ID="Text__CAP_48" runat="server"></asp:TextBox>
                     </td>
                     <td >
                         <asp:TextBox ID="Text_CAP_POR_EP_5" runat="server"></asp:TextBox>
                     </td>
                 </tr>
                 <tr class="style-td-white" height="42">
                     ...
                     <td class="auto-style274">
                         <asp:TextBox ID="Text__CAP_49" runat="server"></asp:TextBox>
                     </td>
                     <td >
                         <asp:TextBox ID="Text_CAP_POR_EP_6" runat="server"></asp:TextBox>
                     </td>
                 </tr>
                 <tr class="style-td-gray" height="42">
                     <td class="style-keyitem-details" height="42" width="192">Min RDL Width/Spacing
                         ...
                         pattern &amp; location</td>
                     <td >
                         <asp:TextBox ID="Text__CAP_50" runat="server"></asp:TextBox>
                     </td>
                     <td >
                         <asp:TextBox ID="Text_CAP_POR_EP_7" runat="server"></asp:TextBox>
                     </td>
                 </tr>
                 <tr class="style-td-white" height="22">
                     ...
                     <td class="style-keyitem-details">Gross die</td>
                     <td class="auto-style274">
                         <asp:TextBox ID="Text__CAP_51" runat="server"></asp:TextBox>
                     </td>
                     <td >
                         <asp:TextBox ID="Text_CAP_POR_EP_8" runat="server"></asp:TextBox>
                     </td>
                 </tr>
                 <tr class="style-td-gray" height="22">
                     <td class="style-keyitem-details" height="22" width="192">Bump count per die</td>
                     <td class="auto-style18">
                         <asp:TextBox ID="Text__CAP_52" runat="server"></asp:TextBox>
                     </td>
                     <td >
                         <asp:TextBox ID="Text_CAP_POR_EP_9" runat="server"></asp:TextBox>
                     </td>
                 </tr>
                 <tr class="style-td-white" height="22">
                     <td class="style-keyitem-details" height="22" width="192">Bump height</td>
                     <td>
                         <asp:TextBox ID="Text__CAP_53" runat="server"></asp:TextBox>
                     </td>
                     <td >
                         <asp:TextBox ID="Text_CAP_POR_EP_10" runat="server"></asp:TextBox>
                     </td>
                 </tr>
                 <tr class="style-td-gray" height="22">
                     <td class="style-keyitem-details" height="22" width="192">Bump diameter</td>
                     <td>
                         <asp:TextBox ID="Text__CAP_54" runat="server"></asp:TextBox>
                     </td>
                     <td >
                         <asp:TextBox ID="Text_CAP_POR_EP_11" runat="server"></asp:TextBox>
                     </td>
                 </tr>
                 <tr class="style-td-white" height="22">
                     ...
                     <td>
                         <asp:TextBox ID="Text__CAP_55" runat="server"></asp:TextBox>
                     </td>
                     <td >
                         <asp:TextBox ID="Text_CAP_POR_EP_12" runat="server"></asp:TextBox>
                     </td>
                 </tr>
                 <tr class="style-td-gray" height="38">
                     ...
                     <td class="style-keyitem-details" width="192">Bump diameter</td>
                     <td width="160">
                         <asp:TextBox ID="Text__CAP_56" runat="server"></asp:TextBox>
                     </td>
                     <td  width="114">
                         <asp:TextBox ID="Text_CAP_POR_EP_13" runat="server"></asp:TextBox>
                     </td>
                 </tr>
                 <tr class="style-td-white" height="22">
                     ...
                     <td class="style-keyitem-details" width="192">Bump diameter</td>
                     <td width="160">
                         <asp:TextBox ID="Text__CAP_57" runat="server"></asp:TextBox>
                     </td>
                     <td >
                         <asp:TextBox ID="Text_CAP_POR_EP_14" runat="server"></asp:TextBox>
                     </td>
                 </tr>
                 <tr class="style-td-gray" height="44">
                     ...
                     <td >
                         <asp:TextBox ID="Text_CAP_POR_EP_15" runat="server"></asp:TextBox>
                     </td>
                 </tr>
                 <tr class="style-td-white">
                     ...
                     <td width="160" class="auto-style1">
                         <asp:TextBox ID="Text__CAP_59" runat="server"></asp:TextBox>
                     </td>
                 ...
                 <tr class="style-td-gray" height="22">
                     ...
                     <td width="160">
                         <asp:TextBox ID="Text__CAP_60" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-white" height="22">
                     ...
                     <td class="style-keyitem-details">　</td>
                     <td width="160">
                         <asp:TextBox ID="Text__CAP_61" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-gray" height="42">
                     ...
                     <td class="style-keyitem-details" width="192">　</td>
                     <td width="160">
                         <asp:TextBox ID="Text__CAP_62" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-white" height="22">
                     ...
                     <td class="style-keyitem-details" width="192">　</td>
                     <td width="160">
                         <asp:TextBox ID="Text__CAP_63" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-gray" height="42">
                     ...
                     <td class="style-keyitem-details" width="192">　</td>
                     <td width="160">
                         <asp:TextBox ID="Text__CAP_64" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
                 <tr class="style-td-white" height="22">
                     ...
                     <td class="style-keyitem-details" width="192">　</td>
                     <td width="160">
                         <asp:TextBox ID="Text__CAP_65" runat="server"></asp:TextBox>
                     </td>
                     <td class="style-td-red">
                         &nbsp;</td>
                 </tr>
